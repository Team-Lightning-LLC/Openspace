    ...
    <div style={styles.container}>
      ...
      <header style={styles.header}>
        ...
        <div style={styles.headerRight}>
          <button style={styles.notificationBtn} onClick={() => onNavigate('messages')}>
      ...
      <main style={styles.main}>
        ...
        <div style={styles.card}>
          ...
          <button style={styles.primaryBtn} onClick={() => onNavigate('advisor')}>
          ...
          {hasLinkedAccounts ? (
            <div style={styles.snapshotGrid}>
              <div style={styles.snapshotItem}>
                ...
                <span style={{...styles.snapshotValue, color: '#1e293b'}}>$24,350</span>
              </div>
              <div style={styles.snapshotItem}>
                <span style={styles.snapshotLabel}>Monthly Surplus</span>
                <span style={{...styles.snapshotValue, color: '#10b981'}}>+$420</span>
              </div>
              <div style={styles.snapshotItem}>
                <span style={styles.snapshotLabel}>Goal Progress</span>
                <span style={{...styles.snapshotValue, color: '#1e293b'}}>34%</span>
              </div>
              <div style={styles.snapshotItem}>
                <span style={styles.snapshotLabel}>Safety Score</span>
                <span style={{...styles.snapshotValue, color: '#f59e0b'}}>B+</span>
              </div>
            </div>
          ) : (
            <>
        ...
        <div style={styles.tasksSection}>
          ...
          <div style={styles.tasksList}>
            ...
            <button 
              style={styles.taskItem}
              onClick={isOnboarded && !hasLinkedAccounts ? onStartAccountLinking : undefined}
            >
              <div style={styles.taskCheck}>
                {hasLinkedAccounts ? (
                  <div style={styles.taskCheckComplete}>✓</div>
              ...
              <div style={styles.taskInfo}>
                ...
                }}>Link your accounts</span>
                {hasLinkedAccounts ? (
                  <span style={styles.taskComplete}>Done</span>
                ) : isOnboarded ? (
                  <span style={styles.taskUrgent}>⚡ Ready to connect</span>
                ) : (
                  <span style={styles.taskPending}>Waiting on profile</span>
                )}
              </div>
              {!hasLinkedAccounts && isOnboarded && (
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#94a3b8" strokeWidth="2">
                  <polyline points="9 18 15 12 9 6"/>
                </svg>
              )}
            ...
            <button 
              style={styles.taskItem}
              onClick={hasLinkedAccounts ? () => onNavigate('plan', 'plan') : undefined}
            >
              <div style={styles.taskCheck}>
                <div style={styles.taskCheckEmpty} />
              </div>
              <div style={styles.taskInfo}>
                ...
                {hasLinkedAccounts ? (
                  <span style={styles.taskUrgent}>⚡ Ready to set</span>
                ) : (
                  <span style={styles.taskPending}>Waiting on accounts</span>
                )}
              </div>
              {hasLinkedAccounts && (
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#94a3b8" strokeWidth="2">
            ...
            {/* Quarterly Update Task */}
            <div style={styles.taskItem}>
              <div style={styles.taskCheck}>
                <div style={styles.taskCheckEmpty} />
              </div>
              <div style={styles.taskInfo}>
                <span style={styles.taskName}>Quarterly profile update</span>
                <span style={styles.taskPending}>Due in 89 days</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <nav style={styles.bottomNav}>
        <button style={styles.bottomNavItem} onClick={() => onNavigate('home', 'home')}>
        ...
        <button style={styles.bottomNavItem} onClick={() => onNavigate('advisor')}>
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#94a3b8" strokeWidth="2">
            <path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/>
          </svg>
          <span style={styles.bottomNavLabel}>Advisor</span>
        </button>
        <button style={styles.bottomNavItem} onClick={() => onNavigate('messages')}>
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#94a3b8" strokeWidth="2">
      ...
      <button style={styles.floatingHelp} onClick={() => onNavigate('advisor')}>
